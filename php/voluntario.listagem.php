...
<html>
	<head>
		<title>voluntario - Listagem</title>
		<link rel="stylesheet" type="text/css" href="../css/listagem.txt">
	</head>
...
for($n = 0; $n<$linhas; $n++){
	...
	//Oq está dentro dos '' é o nome do campo da tabela
		...
		echo "<td> <a href='voluntario.alterar.php?c=$codigo'>Alterar</a></td>";
		echo "<td> <a href='voluntario.validarExlusao.php?c=$codigo'>Excluir</a></td>";
...
echo "<a href='../voluntario.html'><div class='voltar'>Voltar à tela de cadastro</div></a><br></center>";?>
</body>
</html>