...
for($n = 0; $n<$linhas; $n++){
	...
	//Oq está dentro dos '' é o nome do campo da tabela
		...
		echo "<td> <a href='integral.alterar.php?c=$codigo'>Alterar</a></td>";
		echo "<td> <a href='integral.validarExlusao.php?c=$codigo'>Excluir</a></td>";
