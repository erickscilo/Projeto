...
$comandoSQL = "SELECT * FROM futebol WHERE codFunc=$codigo";
...
<div class="voltarmenu">
	<a href="futebol.listagem.php">
		<center><div class="voltar">Voltar para a tela de listagem</div></center>
	</a>
</div>
<form action="futebol.gravar.php" method="post" enctype="multipart/form-data">
