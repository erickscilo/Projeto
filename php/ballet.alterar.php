...
$comandoSQL = "SELECT * FROM ballet WHERE codFunc=$codigo";
...
<div class="voltarmenu">
	<a href="ballet.listagem.php">
		<center><div class="voltar">Voltar para a tela de listagem</div></center>
	</a>
</div>
<form action="ballet.gravar.php" method="post" enctype="multipart/form-data">
