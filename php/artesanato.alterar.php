<html>
	<head>
		<title>artesanato - Alterar</title>
...
$comandoSQL = "SELECT * FROM artesanato WHERE codFunc=$codigo";
...
<div class="voltarmenu">
	<a href="artesanato.listagem.php">
		<center><div class="voltar">Voltar para a tela de listagem</div></center>
	</a>
</div>
<form action="artesanato.gravar.php" method="post" enctype="multipart/form-data">
	...
	<hr>
	<fieldset>
		<legend>Dados maternos</legend>
					
		Nome da Mãe: <input 	type="text" name="nomeMae" size="70" maxlength="70" placeholder="até 50 caracteres" value="<?php echo $nomeMae; ?>">
				<br>				
		RG da mãe: <input type="text" name="cpfMae" value="<?php echo $cpfMae;?>" maxlength="11" size="11">
	</fieldset>
	<br>
	<fieldset>
