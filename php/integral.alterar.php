...
$comandoSQL = "SELECT * FROM inf WHERE codFunc=$codigo";
...
<div class="voltarmenu">
	<a href="integral.listagem.php">
		<center><div class="voltar">Voltar para a tela de listagem</div></center>
	</a>
</div>
<form action="integral.gravar.php" method="post" enctype="multipart/form-data">
