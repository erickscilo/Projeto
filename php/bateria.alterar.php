...
$comandoSQL = "SELECT * FROM bateria WHERE codFunc=$codigo";
...
<div class="voltarmenu">
	<a href="bateria.listagem.php">
		<center><div class="voltar">Voltar para a tela de listagem</div></center>
	</a>
</div>
<form action="bateria.gravar.php" method="post" enctype="multipart/form-data">
